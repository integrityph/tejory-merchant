...
<main class="relative flex h-dvh w-full flex-col gap-5 bg-neutral-200 px-5">
	<section class="relative mt-5 flex h-[40%] flex-col gap-2">
		...
		<div class="h-[100%] rounded-md bg-white p-2 shadow">
			...
			<div class="flex h-[52px] w-full items-center rounded-sm border-0 p-3 text-xl ring-0">
				{fiatAmount}
			</div>
		</div>
		<!-- BTC Input -->
		<div class="h-[100%] rounded-md bg-white p-2 shadow">
			<div class="text-md flex h-10 items-center indent-2 text-gray-500">BTC</div>
			<div class="w-full rounded-sm border-0 p-3 text-xl text-gray-500 ring-0">
	...
	<!-- Numeric Keypad -->
	<section class="h-[45 %] grid grid-cols-3 grid-rows-4 gap-3 rounded-md bg-neutral-300 p-5">
